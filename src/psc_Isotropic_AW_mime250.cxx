...
struct PscTurAW : Psc<PscConfig>
{
  ...
  PscTurAW()
  {
    ...
    // Parameters
    mi_over_me_ = 250.; //Ques_jeff from 10 to 50? Do I have to change something else when I change mi/me?
    vA_over_c_ = .06; //Why 0.1?? 
    amplitude_ = .5;     
    ...
    mpi_printf(comm, "\n");
    p_.nmax = 2437;  // Ques_jeff How long should I run this?
    p_.cfl = 0.98;
    ...
    // --- setup domain
    Grid_t::Real3 LL = {12., 12., 12.}; // domain size (normalized units, ie, in d_i)
    Int3 gdims = {300, 300, 300}; // global number of grid points
    Int3 np = {4, 6, 6}; // division into patches
    ...
    outf_params.pfield_step = 406 ;// 1250; // it was every 100
