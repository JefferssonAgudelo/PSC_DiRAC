...
struct PscTurAW : Psc<PscConfig>
{
  ...
  PscTurAW()
  {
    ...
    mpi_printf(comm, "\n");
    p_.nmax = 15595;  // Ques_jeff How long should I run this?
    p_.cfl = 0.98;
    ...
    outf_params.pfield_step = 2599 ;// 1250; // it was every 100
