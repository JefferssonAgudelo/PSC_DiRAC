...
struct PscTurAW : Psc<PscConfig>
{
  ...
  PscTurAW()
  {
    ...
    // --- setup domain
    Grid_t::Real3 LL = {18., 18., 63.}; // domain size (normalized units, ie, in d_i)
    Int3 gdims = {296, 296, 1024}; // global number of grid points
...
/////////////////////////////////////////////////////////////////////////////////////////////    
    ...
    int m_per=3; //modes in the perpendicular directions
