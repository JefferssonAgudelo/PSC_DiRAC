...
struct PscTurAW : Psc<PscConfig>
{
  ...
  PscTurAW()
  {
    ...
    mpi_printf(comm, "\n");
    p_.nmax = 1461;  // Ques_jeff How long should I run this?
    p_.cfl = 0.98;
    ...
    Int3 gdims = {240, 240, 240}; // global number of grid points
    Int3 np = {4, 4, 6}; // division into patches
    ...
    outf_params.pfield_step = 365 ;// 1250; // it was every 100
