...
struct PscTurAW : Psc<PscConfig>
{
  ...
  PscTurAW()
  {
    ...
    mpi_printf(comm, "\n");
    p_.nmax = 401;  // Ques_jeff How long should I run this?
    p_.cfl = 0.98;
    ...
    norm_params.nicell = 2; // Ques_jeff 100 particles ??
...
//   C1 = 1./sqrt(sqr(Amp1)+sqr(Amp2)+sqr(Amp3)+sqr(Amp4)+sqr(Amp5)+sqr(Amp6)+sqr(Amp7)+sqr(Amp8)); //    
...
/////////////////////////////////////////////////////////////////////////////////////////////
	  ...
	  switch (m) {
	  case HX: return  C2*dB_axT;
	  case HY: return  C2*dB_ayT;
	  case HZ: return B0;
