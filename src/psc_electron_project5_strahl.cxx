...
struct ElectronProject : Psc<PscConfig>
{
  ...
  // ----------------------------------------------------------------------
    ...
    beta_i_par_ = .7188;
    beta_e_core_par_ = .5027;
    beta_e_strahl_par_ = .0059;
    Ti_per_over_Ti_par_ = 1.;
    Te_c_per_over_Te_c_par_ = .9559;
    Te_s_per_over_Te_s_par_ = 1.7921;    
    ...
    Ve_core_par_ = 0.5986 * vA_over_c_;
    Ve_strahl_per_ = 0.* vA_over_c_;
    Ve_strahl_par_ = -67.9958 * vA_over_c_;	   
  ...
  // ----------------------------------------------------------------------	
    ...
    Int3 gdims = { 1, 800, 800}; // global number of grid points
