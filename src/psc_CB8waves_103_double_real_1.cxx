...
struct PscTurAW : Psc<PscConfig>
{
  ...
  PscTurAW()
  {
    ...
    mpi_printf(comm, "\n");
    p_.nmax = 23601;  // Ques_jeff How long should I run this?
    p_.cfl = 0.98;
    ...
    Int3 gdims = {540, 540, 3000}; // global number of grid points
    Int3 np = {12, 12, 60}; // division into patches
