...
struct PscTurAW : Psc<PscConfig>
{
  ...
  PscTurAW()
  {
    ...
    mpi_printf(comm, "\n");
    p_.nmax = 5359;  // Ques_jeff How long should I run this?
    p_.cfl = 0.98;
    ...
    Int3 gdims = {440, 440, 440}; // global number of grid points
    Int3 np = {8, 8, 8}; // division into patches
    ...
    outf_params.pfield_step = 893 ;// 1250; // it was every 100
