...
struct PscTurAW : Psc<PscConfig>
{
  ...
  PscTurAW()
  {
    ...
    mpi_printf(comm, "\n");
    p_.nmax = 975;  // Ques_jeff How long should I run this?
    p_.cfl = 0.98;
    ...
    Int3 np = {4, 4, 4}; // division into patches
    ...
    norm_params.nicell = 150; // Ques_jeff 100 particles ??
    ...
    outf_params.pfield_step = 162 ;// 1250; // it was every 100
